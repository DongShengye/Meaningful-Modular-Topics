...
if __name__ == "__main__":
    ...
    image_count = 10
    camera_intrensics = np.loadtxt("C:/Users\/bests/OneDrive/Desktop/hw1/hw1/data/camera-intrinsics.txt", delimiter=' ') #C:/Users\/bests/OneDrive/Desktop/hw1/hw1/data
    ...
    for i in range(image_count):
        ...
        color_image = read_rgb("C:/Users\/bests/OneDrive/Desktop/hw1/hw1/data/frame-%06d.color.png"%(i))
        depth_image = read_depth("C:/Users\/bests/OneDrive/Desktop/hw1/hw1/data/frame-%06d.depth.png"%(i))
        camera_pose = np.loadtxt("C:/Users\/bests/OneDrive/Desktop/hw1/hw1/data/frame-%06d.pose.txt"%(i))
    ...
    mesh.write("C:/Users/bests/OneDrive/Desktop/hw1/hw1/supplemental/mesh.ply")

    # Get point cloud from voxel volume and save to disk (can be viewed with Meshlab)
    print("Saving point cloud to point_cloud.ply...")
    pc = Ply(points=points, normals=normals, colors=colors)
    pc.write("C:/Users/bests/OneDrive/Desktop/hw1/hw1/supplemental/point_cloud.ply")
